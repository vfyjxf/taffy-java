package dev.vfyjxf.taffy.generated.intrinsic;
...
/**
 * Generated tests for intrinsic layout fixtures.
 */
public class IntrinsicTest {
    ...
    @Test
    @DisplayName("fit_content_width_in_flex__border_box")
    void fitContentWidthInFlexBorderBox() {
        TaffyTree tree = new TaffyTree();

        TaffyStyle node0Style = new TaffyStyle();
        node0Style.direction = TaffyDirection.LTR;
        node0Style.size = new TaffySize<>(TaffyDimension.fitContent(), TaffyDimension.length(50.0f));
        MeasureFunc node0Measure = ahemTextMeasure("Hello World", false);
        ...
        nodeStyle.size = new TaffySize<>(TaffyDimension.length(500.0f), TaffyDimension.length(100.0f));
        ...
        assertEquals(110.0f, node0Layout.size().width, "width of node0");
        ...
        assertEquals(110.0f, node1Layout.location().x, "x of node1");
        assertEquals(0.0f, node1Layout.location().y, "y of node1");
    }

    @Test
    @DisplayName("fit_content_width_in_flex__content_box")
    void fitContentWidthInFlexContentBox() {
        TaffyTree tree = new TaffyTree();
    ...
    @Test
    @DisplayName("max_content_height_in_flex__border_box")
    void maxContentHeightInFlexBorderBox() {
        TaffyTree tree = new TaffyTree();

        TaffyStyle node0Style = new TaffyStyle();
        node0Style.direction = TaffyDirection.LTR;
        node0Style.size = new TaffySize<>(TaffyDimension.length(50.0f), TaffyDimension.maxContent());
        MeasureFunc node0Measure = ahemTextMeasure("Hello\u200BWorld", false);
        NodeId node0 = tree.newLeafWithMeasure(node0Style, node0Measure);
    ...
    @Test
    @DisplayName("max_content_height_in_flex__content_box")
    void maxContentHeightInFlexContentBox() {
        TaffyTree tree = new TaffyTree();
    ...
    @Test
    @DisplayName("max_content_width_in_flex__border_box")
    void maxContentWidthInFlexBorderBox() {
        TaffyTree tree = new TaffyTree();

        TaffyStyle node0Style = new TaffyStyle();
        node0Style.direction = TaffyDirection.LTR;
        node0Style.size = new TaffySize<>(TaffyDimension.maxContent(), TaffyDimension.length(50.0f));
        MeasureFunc node0Measure = ahemTextMeasure("Hello World", false);
        NodeId node0 = tree.newLeafWithMeasure(node0Style, node0Measure);
    ...
    @Test
    @DisplayName("max_content_width_in_flex__content_box")
    void maxContentWidthInFlexContentBox() {
        TaffyTree tree = new TaffyTree();
    ...
    @Test
    @DisplayName("min_content_height_in_flex__border_box")
    void minContentHeightInFlexBorderBox() {
        TaffyTree tree = new TaffyTree();

        TaffyStyle node0Style = new TaffyStyle();
        node0Style.direction = TaffyDirection.LTR;
        node0Style.size = new TaffySize<>(TaffyDimension.length(50.0f), TaffyDimension.minContent());
        MeasureFunc node0Measure = ahemTextMeasure("Hello\u200BWorld", false);
        NodeId node0 = tree.newLeafWithMeasure(node0Style, node0Measure);
    ...
    @Test
    @DisplayName("min_content_height_in_flex__content_box")
    void minContentHeightInFlexContentBox() {
        TaffyTree tree = new TaffyTree();
    ...
    @Test
    @DisplayName("min_content_width_in_flex__border_box")
    void minContentWidthInFlexBorderBox() {
        TaffyTree tree = new TaffyTree();

        TaffyStyle node0Style = new TaffyStyle();
        node0Style.direction = TaffyDirection.LTR;
        node0Style.size = new TaffySize<>(TaffyDimension.minContent(), TaffyDimension.length(50.0f));
        MeasureFunc node0Measure = ahemTextMeasure("Hello\u200BWorld", false);
        NodeId node0 = tree.newLeafWithMeasure(node0Style, node0Measure);
    ...
    @Test
    @DisplayName("min_content_width_in_flex__content_box")
    void minContentWidthInFlexContentBox() {
        TaffyTree tree = new TaffyTree();
    ...
    @Test
    @DisplayName("stretch_height_in_flex_column__border_box")
    void stretchHeightInFlexColumnBorderBox() {
        TaffyTree tree = new TaffyTree();

        TaffyStyle node0Style = new TaffyStyle();
        node0Style.direction = TaffyDirection.LTR;
        node0Style.size = new TaffySize<>(TaffyDimension.length(50.0f), TaffyDimension.stretch());
    ...
    @Test
    @DisplayName("stretch_height_in_flex_column__content_box")
    void stretchHeightInFlexColumnContentBox() {
        TaffyTree tree = new TaffyTree();
    ...
    @Test
    @DisplayName("stretch_multiple_children__border_box")
    void stretchMultipleChildrenBorderBox() {
        TaffyTree tree = new TaffyTree();

        TaffyStyle node0Style = new TaffyStyle();
        node0Style.direction = TaffyDirection.LTR;
        node0Style.size = new TaffySize<>(TaffyDimension.stretch(), TaffyDimension.length(50.0f));
        NodeId node0 = tree.newLeaf(node0Style);

        TaffyStyle node1Style = new TaffyStyle();
        node1Style.direction = TaffyDirection.LTR;
        node1Style.size = new TaffySize<>(TaffyDimension.stretch(), TaffyDimension.length(50.0f));
        NodeId node1 = tree.newLeaf(node1Style);

        TaffyStyle node2Style = new TaffyStyle();
        node2Style.direction = TaffyDirection.LTR;
        node2Style.size = new TaffySize<>(TaffyDimension.stretch(), TaffyDimension.length(50.0f));
    ...
    @Test
    @DisplayName("stretch_multiple_children__content_box")
    void stretchMultipleChildrenContentBox() {
        TaffyTree tree = new TaffyTree();
    ...
    @Test
    @DisplayName("stretch_width_in_flex_row__border_box")
    void stretchWidthInFlexRowBorderBox() {
        TaffyTree tree = new TaffyTree();
    ...
    @Test
    @DisplayName("stretch_width_in_flex_row__content_box")
    void stretchWidthInFlexRowContentBox() {
        TaffyTree tree = new TaffyTree();
    ...
    @Test
    @DisplayName("stretch_with_min_max__border_box")
    void stretchWithMinMaxBorderBox() {
        TaffyTree tree = new TaffyTree();

        TaffyStyle node0Style = new TaffyStyle();
        node0Style.direction = TaffyDirection.LTR;
        node0Style.size = new TaffySize<>(TaffyDimension.stretch(), TaffyDimension.length(50.0f));
        node0Style.minSize = new TaffySize<>(TaffyDimension.length(50.0f), TaffyDimension.AUTO);
        node0Style.maxSize = new TaffySize<>(TaffyDimension.length(200.0f), TaffyDimension.AUTO);
        NodeId node0 = tree.newLeaf(node0Style);
    ...
    @Test
    @DisplayName("stretch_with_min_max__content_box")
    void stretchWithMinMaxContentBox() {
        TaffyTree tree = new TaffyTree();
